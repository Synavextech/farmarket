            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <div
                        ...
                        style={{ backgroundImage: "url('/images/hero_coffee.gif')" }}
                    ></div>
                </div>
                ...
                <div className="container mx-auto px-6 relative z-10 text-center flex flex-col items-center">
                    <div className="inline-block mb-4 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-bold tracking-widest uppercase backdrop-blur-md animate-in fade-in slide-in-from-bottom-4 duration-700">
                        Welcome to the Future of Farming - where automation meets agriculture to foster efficiency and transparency
                    </div>
                ...
                <div className="container mx-auto px-6 relative">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl text-muted-foreground leading-relaxed">
                            To empower Kenyan smallholder farmers through digital literacy and automated tracking systems. We aim to provide a transparent, efficient ecosystem where every coffee deposit is accounted for, ensuring fair valuation and real-time insights from farm to market.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="glass-effect p-8 rounded-3xl border border-white/10 hover:border-primary/50 transition-all group overflow-hidden relative">
                            ...
                            <h3 className="text-xl font-bold mb-4 relative z-10 group-hover:text-primary transition-colors">Centralized Farm Management & AI Automation</h3>
                            ...
                            <div className="h-[200px] w-full rounded-xl overflow-hidden relative z-10 border border-white/10">
                                <img src="/images/A-farming_automation.gif" alt="AI Farming Automation" className="w-full h-full object-cover transform scale-100 group-hover:scale-105 transition-transform duration-700" />
                            </div>
                        </div>

                        {/* Service 2 */}
                        <div className="glass-effect p-8 rounded-3xl border border-white/10 hover:border-primary/50 transition-all group relative overflow-hidden">
                            <div className="absolute -left-20 -bottom-20 w-64 h-64 bg-yellow-500/10 rounded-full blur-[80px] group-hover:bg-yellow-500/20 transition-all"></div>
                            <h3 className="text-xl font-bold mb-4 relative z-10 group-hover:text-primary transition-colors">Coffee Grading & Valuation</h3>
                            <p className="text-sm text-muted-foreground mb-6 relative z-10">
                            ...
                            <div className="h-[200px] w-full rounded-xl overflow-hidden relative z-10 border border-white/10">
                                <img src="/images/coffee_grading.gif" alt="Coffee Grading & Valuation" className="w-full h-full object-cover transform scale-100 group-hover:scale-105 transition-transform duration-700" />
                            </div>
                        </div>
                        ...
                        <div className="glass-effect p-8 rounded-3xl border border-white/10 hover:border-primary/50 transition-all group relative overflow-hidden">
                            ...
                            <h3 className="text-xl font-bold mb-4 relative z-10 group-hover:text-primary transition-colors">Real-Time Data Tracking & Consultation</h3>
                            <p className="text-sm text-muted-foreground mb-6 relative z-10">
                                Real-time data tracking for all farm products with comprehensive analysis and reports. We offer further personal-level consultations for coffee, cattle, and firm produce.
                            </p>
                            <div className="h-[200px] w-full rounded-xl overflow-hidden relative z-10 border border-white/10">
                                <img src="/images/coffee_data.gif" alt="Real-Time Data Tracking" className="w-full h-full object-cover transform scale-100 group-hover:scale-105 transition-transform duration-700" />
                            </div>
                        </div>

                        {/* Service 4 */}
                        <div className="glass-effect p-8 rounded-3xl border border-white/10 hover:border-primary/50 transition-all group relative overflow-hidden">
                            <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-blue-500/10 rounded-full blur-[80px] group-hover:bg-blue-500/20 transition-all"></div>
                            <h3 className="text-xl font-bold mb-4 relative z-10 group-hover:text-primary transition-colors">Futuristic Research on Coffee Production</h3>
                            <p className="text-sm text-muted-foreground mb-6 relative z-10">
                                Driving innovation through deep research into resilient coffee varieties, pest management, and climate-adaptive cultivation techniques.
                            </p>
                            <div className="h-[200px] w-full rounded-xl overflow-hidden relative z-10 border border-white/10">
                                <img src="/images/Ai_farming.gif" alt="Coffee Research" className="w-full h-full object-cover transform scale-100 group-hover:scale-105 transition-transform duration-700" />
                            </div>
                        </div>
                    </div>
                </div>
